...
public:
  ...
  registerBuilder("SinSum",
                  []() { return std::unique_ptr<OptimizationTask>(new SinSum); });
  registerBuilder("SinProd",
                  []() { return std::unique_ptr<OptimizationTask>(new SinProd); });
  }
};
